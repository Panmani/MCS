...
def make_dataloader(cfg, dataset=None, mode='train', distributed=False, num_replicas=None, rank=None,
    ...
    if mode == 'train':
        ...
        comet_ann_file = cfg.DATASET.TRAIN_COMET_FILE
        true_comet_ann_file = cfg.DATASET.TRUE_TRAIN_COMET_FILE
        ...
        comet_ann_file = cfg.DATASET.VAL_COMET_FILE
        true_comet_ann_file = cfg.DATASET.TRUE_VAL_COMET_FILE
        ...
        comet_ann_file = cfg.DATASET.TEST_COMET_FILE
        true_comet_ann_file = cfg.DATASET.TRUE_TEST_COMET_FILE
    ...
    if dataset is None:
        ...
        dataset = build_dataset(dataset_name=cfg.DATASET.DATASET, ann_file=ann_file, image_set=image_set,
                                ...
                                comet_ann_file=comet_ann_file, true_comet_ann_file=true_comet_ann_file, comet_data_path=cfg.DATASET.COMET_DATASET_PATH,
                                **kwargs)
